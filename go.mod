module unreal.sh/neo

go 1.21.4

require (
	github.com/Necroforger/dgwidgets v0.0.0-20190131052008-56c8c1ca33e0 // indirect
	...
	github.com/matryer/goscript v0.0.0-20170731125849-1a0cb0e0df70 // indirect
