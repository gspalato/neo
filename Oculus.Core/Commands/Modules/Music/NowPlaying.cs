...
namespace Oculus.Core.Commands.Modules.Music
{
	...
	public sealed class NowPlaying : OculusModule
	{
		...
		private static string GenerateSlider(LavaTrack track, int sliderSize = 30)
		{
			...
			double sliderPosition = track.Position.TotalSeconds * sliderSize / track.Duration.TotalSeconds;
